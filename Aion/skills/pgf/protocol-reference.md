...
> **[Vision Document]** This document describes PGF's future extension directions. PGF-MCP and PGF-A2A have no current implementations and are design visions that cannot be directly executed at this time. In the current environment, use the execution modes in SKILL.md and Antigravity skill integration.
...
│
├──→ Worker #1 (Antigravity Agent)       receives SubTask_Logic.PGF
