...
```jsonc
{
  ...
  "agent_role": "string",           // 역할 (Master Orchestrator, Chronicler, Infrastructure Manager, ...)
  "runtime": "string",              // 런타임 (antigravity_subagent, browser_subagent, python_exec, ...)
  "runtime_version": "string",      // 런타임 버전 (gemini-1.5-pro, browser-subagent-v2.1, ...)
...
```json
{
  "task_class": "browser_navigation",
  "agent_role": "search_agent",
  "runtime": "browser_subagent",
