...
- Generated: 2026-04-02T11:45:02.483968+09:00
- Ticks: 2
- Interval sec: 0.0
- Apply mode: True
...
- SA_ORCHESTRATOR_scan_state: scan_state: drift=False mailbox_pending=2 shared_impact=True rollout_gate=guarded
- SA_ORCHESTRATOR_detect_conflict: detect_conflict: mailbox shared-impact items=2; direct reply guard remains open; shared registry alignment remains guarded; runtime readiness gate=guarded
- SA_ORCHESTRATOR_sync_mailbox: sync_mailbox: pending=2 shared-impact=2 advisory persisted
...
- mailbox advisory: pending=2, shared-impact=2, flagged=0, top='Shared readiness handover', target=NAEL
...
- reason: mailbox shared-impact items=2
