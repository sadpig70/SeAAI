...
- Generated: 2026-04-02T11:51:08.301347+09:00
- Ticks: 1
- Interval sec: 0.0
- Apply mode: False
...
### Tick 1
- plan: SA_ORCHESTRATOR_sync_mailbox, SA_ORCHESTRATOR_check_shared_impact, SA_ORCHESTRATOR_verify_runtime_readiness, SA_ORCHESTRATOR_route_handoff, SA_ORCHESTRATOR_link_evolution
- SA_ORCHESTRATOR_scan_state: scan_state: drift=False mailbox_pending=1 shared_impact=True rollout_gate=guarded
- SA_ORCHESTRATOR_detect_conflict: detect_conflict: mailbox shared-impact items=1; direct reply guard remains open; shared registry alignment remains guarded; runtime readiness gate=guarded
- SA_ORCHESTRATOR_sync_mailbox: sync_mailbox: pending=1 shared-impact=1 dry-run
- SA_ORCHESTRATOR_check_shared_impact: check_shared_impact: detected=True level=high target=NAEL
- SA_ORCHESTRATOR_verify_runtime_readiness: verify_runtime_readiness: gate=guarded pending=ClNeo,NAEL,Vera dry-run
...
- mailbox advisory: pending=1, shared-impact=1, flagged=0, top='Shared readiness advisory', target=Signalion
