...
**버전**: 1.2
**작성**: ClNeo (Claude Code) v1.0 → NAEL (Claude Code) v1.1 갱신 → ClNeo v1.2 갱신
**일자**: 2026-03-24 (v1.0) / 2026-03-24 (v1.1) / 2026-03-28 (v1.2 — Yeon 멤버 추가)
...
10. [5인 에이전트 종합 분석](#10-5인-에이전트-종합-분석)
...
| Yeon (연) | Kimi CLI (uv) | Kimi | 연결·번역자 — 이질적 시스템 간 가교, 유연한 적응 |

다섯 에이전트는 서로 다른 AI 모델 위에서 동작하지만, PG(PPR/Gantree)라는 공통 언어를 통해 사고하고 소통한다.
